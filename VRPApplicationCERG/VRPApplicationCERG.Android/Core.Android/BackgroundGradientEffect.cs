...
namespace VRPApplicationCERG.Droid.Core.Android
{
    public class BackgroundGradientEffect : BaseEffect
    {
        ...
        {
            View targetElement = GetTargetElement();
            try
            {
            ...
            if (!forceRegenerateGradient && !(Element is Xamarin.Forms.Button) && Build.VERSION.SdkInt >= BuildVersionCodes.M)
            {
            ...
            Xamarin.Forms.BoxView boxView = base.Element as Xamarin.Forms.BoxView;
            if (boxView != null && boxView.CornerRadius != default(Xamarin.Forms.CornerRadius))
            {
            ...
            bool flag = true;
            Xamarin.Forms.Button button = base.Element as Xamarin.Forms.Button;
            if (button != null)
            {
                ...
                {
                    Color color = GetRippleColor(button, targetElement).AddLuminosity(-0.12).ToAndroid();
        ...
        private Xamarin.Forms.Color GetRippleColor(Xamarin.Forms.Button button, View targetView)
        {
            Xamarin.Forms.Color result = (button.BackgroundColor != Xamarin.Forms.Color.Default) ? button.BackgroundColor : Xamarin.Forms.Forms.GetColorButtonNormal(targetView.Context);
