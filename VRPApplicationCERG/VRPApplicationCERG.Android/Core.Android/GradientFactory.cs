...
namespace VRPApplicationCERG.Droid.Core.Android
{
    internal static class GradientFactory
    {
        ...
        {
            private readonly VRPApplicationCERG.Core.RadialGradient _radial;

            private readonly Context _context;

            public Radius(VRPApplicationCERG.Core.RadialGradient radial, Context context)
            {
                _radial = radial;
                _context = context;
            }
        ...
        private class RadialGradientShaderFactory : ShapeDrawable.ShaderFactory
        {
            ...
            public override Shader Resize(int width, int height)
            {
                ...
                RadialGradient radialGradient = new RadialGradient(num, num2, x, _colors, _positions, Shader.TileMode.Clamp);
        ...
        private class LinearGradientShaderFactory : ShapeDrawable.ShaderFactory
        {
            ...
            public override Shader Resize(int width, int height)
            {
                ...
                LinearGradient linearGradient = new LinearGradient(0f, height, 0f, 0f, _colors, _positions, Shader.TileMode.Clamp);
                Matrix matrix = new Matrix();
        ...
        private static ShapeDrawable.ShaderFactory BuildShaderFactory(Gradient gradient, Context context, double fixedHeight)
        {
            ...
            VRPApplicationCERG.Core.LinearGradient linearGradient = gradient as VRPApplicationCERG.Core.LinearGradient;
            ...
            VRPApplicationCERG.Core.RadialGradient radialGradient = gradient as VRPApplicationCERG.Core.RadialGradient;
