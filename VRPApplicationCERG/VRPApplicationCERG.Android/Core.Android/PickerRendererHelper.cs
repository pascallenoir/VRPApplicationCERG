...
namespace VRPApplicationCERG.Droid.Core.Android
{
    ...
    internal class PickerRendererHelper<TPicker, TControl> : BorderRendererHelper<TPicker> where TPicker : Xamarin.Forms.View where TControl : View
    {
        private Action<GravityFlags> _setTextAlignment;
        ...
        protected override View Renderer => (View)(object)(_renderer ?? _rendererAppCompat);

        protected override View Control => (_renderer != null) ? _renderer.Control : _rendererAppCompat.Control;
