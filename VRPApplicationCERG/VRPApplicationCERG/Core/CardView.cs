...
namespace VRPApplicationCERG.Core
{
	...
	public class CardView : ContentView
	{
		...
		public CardView()
		{
			...
			VRPApplicationCERG.Core.Effects.SetShadowIOSColor(this, new Color(0.0, 0.0, 0.0, 0.5));
			UpdateCorners();
			UpdateShadow();
			UpdateBackground();
			UpdateShadowSize();
		...
		private void UpdateCorners()
		{
			...
			if (!(runtimePlatform == "iOS"))
			{
				...
				{
					VRPApplicationCERG.Core.Effects.SetCornerRadius(this, CornerRadius);
				}
			}
			else
			{
				VRPApplicationCERG.Core.Effects.SetCornerRadius(Content, CornerRadius);
			}
		}

		private void UpdateShadowSize()
		{
			VRPApplicationCERG.Core.Effects.SetShadowSize(this, ShadowSize);
		}

		private void UpdateShadowOpacity()
		{
			VRPApplicationCERG.Core.Effects.SetShadowOpacity(this, ShadowOpacity);
		}

		private void UpdateShadow()
		{
			VRPApplicationCERG.Core.Effects.SetShadow(this, HasShadow);
		}
