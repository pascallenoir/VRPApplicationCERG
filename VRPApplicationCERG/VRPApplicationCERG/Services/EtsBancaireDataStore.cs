...
{
    public class EtsBancaireDataStore : IDataStoreWEB<ETS_BANCAIRE>
    {
        IRestService<ETS_BANCAIRE> _restService;

        /// <summary>
        /// Constructeur 
        /// </summary>
        /// <param name="service"></param>
        public EtsBancaireDataStore(IRestService<ETS_BANCAIRE> service)
        {
        ...
        /// </summary>
        /// <param name="service"></param>
        public Task<List<ETS_BANCAIRE>> GetTasksAsync()
        {
        ...
        /// </summary>
        /// <param name="service"></param>
        public Task<List<ETS_BANCAIRE>> RefreshDataAsyncWithItem(string item)
        {
        ...
        /// </summary>
        /// <param name="service"></param>
        public Task<List<ETS_BANCAIRE>> RefreshDatafreshAsync(bool forceRefresh = false)
        {
        ...
        /// </summary>
        /// <param name="service"></param>
        public Task SaveTodoItemAsync(ETS_BANCAIRE item, bool isNewItem = false)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public Task<ETS_BANCAIRE> GetItemAsync(string id)
        {
