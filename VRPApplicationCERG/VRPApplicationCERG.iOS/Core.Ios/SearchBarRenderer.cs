...
namespace VRPApplicationCERG.iOS.Core.Ios
{
    ...
    {
        public static readonly BindableProperty __GrialSearchBarBorderChanged = BindableProperty.CreateAttached("__GrialSearchBarBorderChanged", typeof(bool), typeof(VRPApplicationCERG.iOS.Core.Ios.SearchBarRenderer), false);
